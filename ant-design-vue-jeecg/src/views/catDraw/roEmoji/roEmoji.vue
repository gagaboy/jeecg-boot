<template>
  ...
  <a-popover
    ...
    overlayClassName="cat-draw-emoji"
    placement="bottomRight"
    style="padding: 0px"
  >
    <a-icon v-if="showPoptip" class="cursor-pointer" type="smile" />
...
import roEmojiPicker from '@comp/taskFlow/roEmoji/roEmojiPicker/roEmojiPicker' //emoji输入框

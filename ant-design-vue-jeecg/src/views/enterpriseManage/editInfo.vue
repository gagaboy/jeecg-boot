...
<script>
import { addEntInfo, areaList, industryList, entInfoId, entInfoUpdate } from '@/api/api.js'
import { mapGetters } from 'vuex'
import { getFathersById, handleId } from './editInfo.js'
...
export default {
  ...
  methods: {
    getentInfoId() {
      ...
      // this.fileList.push({
      //   url: this.formContract.contractsUrlList[0],
      //   uid: '-1',
      //   name: this.formContract.contractsUrlObjectList[0],
      //   status: 'done',
      // })
      // this.editItem.result.entContractsList[0].contractsUrlObjectList[0].uid = '9953eebf-7955-458d-be5c-fc9fae598f9d'
      this.fileList = this.editItem.result.entContractsList[0].contractsUrlObjectList

      // console.log(this.editItem.result.entContractsList[0].contractsUrlObjectList)
    ...
    industryChange(value) {
      ...
      // console.log(this.form.industryList)
    ...
    contractChange(info) {
      ...
      // this.formContract.contractsUrlList = []

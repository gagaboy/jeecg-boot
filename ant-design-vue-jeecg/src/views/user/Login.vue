      ...
      <a-form-model-item required prop="username">
        <a-row :gutter="0">
          <a-col :span="3">
            <a-icon
              type="user"
              :class="['input-transform', { 'input-focus': inputFous == 'username' }]"
              :style="{ color: 'rgba(255,255,255,.3)', fontSize: '16px' }"
            />
          </a-col>
          <a-col :span="21">
            <a-input
      ...
      <a-form-model-item required prop="password">
        <a-row :gutter="0">
          <a-col :span="3">
            <a-icon
              type="lock"
              :class="['input-transform', { 'input-focus': inputFous == 'password' }]"
              :style="{ color: 'rgba(255,255,255,.3)', fontSize: '16px' }"
            />
          </a-col>
          <a-col :span="21">
      ...
      <a-row :gutter="0">
          ...
          <a-form-model-item required prop="inputCode">
            <a-row :gutter="0">
              <a-col :span="5">
                <a-icon
                  type="safety"
                  :class="['input-transform', { 'input-focus': inputFous == 'safety' }]"
                  :style="{ color: 'rgba(255,255,255,.3)', fontSize: '16px' }"
              /></a-col>
              <a-col :span="19">
                <a-input
        ...
        <a-col :span="11" style="text-align: right">
          <img
            ...
            style="margin-top: 4px; height: 30px"
            :src="randCodeImage"

<template>
	<div>
		...
		<div class="draw-side-menu">
			<menuCommonTop @catBackButton="catBackButton" :showBackButton="showBackButton" topTitle="加入用户组动作"></menuCommonTop>
            ...
            <span class="txt-limit" >{{nowNode.nodeName && nowNode.nodeName.length || 0}} / 25</span>
				...
				<div class="draw-side-menu-trigger-title">将当前用户添加到</div>

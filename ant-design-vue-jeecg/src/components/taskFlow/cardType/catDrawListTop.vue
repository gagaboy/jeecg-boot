<template>
	<div>
		<div class="draw-flex-center instance-top">
			<div class="draw-flex-center">
				<div class="draw-flex-center add-content-txt" style="font-size: 12px; margin-left: 0; margin-right: 12px; color: inherit">
...
<script>
	import {emojiCharStringLen, emojiCharStringSubstr} from '../assets/js/util'
		...
		data: function() {
			return {
				...
				menusIcon: {
					...
					'singleCard': {
						txt: '单卡',
						img: require('../assets/simpleCard1.png'),
					},
					'manyCards': {
						txt: '多卡',
						img: require('../assets/multipleCard1.png'),
					},
					'conversionTemplate': {
						txt: '转换模板',
						img: require('../assets/conversionTemplate1.png'),
					},
				},
			}
		},

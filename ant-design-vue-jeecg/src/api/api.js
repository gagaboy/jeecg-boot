...
//企业信息管理
const entInfoList = (params) => getAction("/entInfo/list", params);
const areaList = (params) => getAction("/sys/area/list", params);
const industryList = (params) => getAction("/industry/list", params);
const entInfoId = (params) => getAction("/entInfo/get", params);
